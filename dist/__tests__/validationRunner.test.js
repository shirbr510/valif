...
var _validationRunner = require('../validationRunner');
...
describe('runValidations', function () {
  ...
  test('empty validation rules should return no validation errors', function () {
    var validationRules = {};
    var result = (0, _validationRunner.runValidations)(validationRules, testSubject);
...
describe('runRule', function () {
  ...
  test('validationRule without message should return DEFAULT_INVALID_FIELD_MESSAGE on invalid value', function () {
    ...
    var value = null;
    var result = (0, _validationRunner.runRule)(validationRule, value);
    expect(result).toEqual(_validationRunner.DEFAULT_INVALID_FIELD_MESSAGE);
  });
